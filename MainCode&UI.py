...
l1.place(x=0, y=10)  # Place the image at the top-left corner (0, 0)
...
mark_attendance_button.place(x=820, y=450)
...
'''def mark_attendance_ui():
    ...
    while True:
        ...
        if not students:  # All students marked, exit the loop
            break
